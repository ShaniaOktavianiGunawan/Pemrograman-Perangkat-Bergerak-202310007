...
const HomeScreen = ({navigation}) => {
  const categoryIcons = [
    <Icon name="flight" size={25} color={'primary'} />,
    <Icon name="beach-access" size={25} color={'primary'} />,
    <Icon name="near-me" size={25} color={'primary'} />,
    <Icon name="place" size={25} color={'primary'} />,
  ];
